...
if (isset($_POST['submit'])) {
    ...
    $sql = "SELECT * FROM kategori_artikel WHERE nama_kategori='$nama_kategori'";
    $result = mysqli_query($mysqli, $sql);
    if ($result->num_rows > 0) {
        echo "<script>alert('Nama Kategori sudah ada. Silahkan coba lagi!')</script>";
    } else {
        $result = mysqli_query($mysqli, "INSERT INTO kategori_artikel(nama_kategori) VALUES('$nama_kategori')");
