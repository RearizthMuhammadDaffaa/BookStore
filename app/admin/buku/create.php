...
if (isset($_POST['submit'])) {
    ...
    $slug = preg_replace('/[^a-z0-9]+/i', '-', trim(strtolower($_POST["judul_buku"])));
    ...
    $sql = "SELECT * FROM data_buku WHERE judul_buku='$judul_artikel'";
    ...
    if (is_uploaded_file($gambar['tmp_name'])) { //cek apakah ada file yang di upload
        ...
        if (!in_array(($tipe), $ext)) { //cek ekstensi file
            ...
            if (move_uploaded_file($gambar['tmp_name'], $dir . $newName)) {
                ...
                $result = mysqli_query($mysqli, "INSERT INTO data_buku(judul_buku,deskripsi,harga,gambar,id_kategori, jumlah_buku)
                    VALUES('$judul_buku','$deskripsi','$harga','$newName','$kategori','$jumlah_buku')");
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <form action="../buku/create.php?page=artikel" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php
                                            $kategori = mysqli_query($mysqli, "SELECT * FROM kategori ORDER BY id DESC");
                                            ?>
                                            <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="content_artikel">jumlah buku</label>
