...
$res_artikel = mysqli_query($mysqli, "SELECT * FROM tb_gallery WHERE id= $id ");
...
if (isset($_POST['update'])) {
    ...
    if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
        ...
        $file_name = $nama;
        $result = mysqli_query($mysqli, "UPDATE tb_gallery SET gambar='$file_name',nama='$nama_gallery'
    WHERE id=$id");
                                ...
                                <div class="card-body">
                                    ...
                                    <form  method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?= $row_nama_header ?>" name="nama_gallery" required>
                                        </div>
