...
if (isset($_POST['submit'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        $result = mysqli_query($mysqli, "INSERT INTO tb_admin (username,nama_operator,password) VALUES('$username','$nama_operator','$password')");
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <form action="../users_admin/create.php" method="post" name="form1">
